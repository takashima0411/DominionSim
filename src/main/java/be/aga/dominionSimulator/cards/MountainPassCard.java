...
public class MountainPassCard extends DomCard {
    public MountainPassCard() {
        super(DomCardName.MountainPass);
    }

    public static void doTheAuction(DomPlayer owner) {
        if (DomEngine.haveToLog) DomEngine.addToLog("Starting auction for " + DomCardName.MountainPass.toHTML());
        int highestBid = 0;
