...
public class SpiceMerchantCard extends DomCard {
    public SpiceMerchantCard() {
        super(DomCardName.SpiceMerchant);
    }
    ...
    public void play() {
        ...
        if (owner.getPlayStrategyFor(this) == DomPlayStrategy.FoolsGoldEnabler
                ...
                && owner.getCurrentGame().countInSupply(DomCardName.FoolsGold) > 1) {
            playForMoney();
            return;
        }
        playForCards();
