...
public class BorderVillageCard extends DomCard {
    public BorderVillageCard() {
        super(DomCardName.BorderVillage);
    }
    ...
    public boolean wantsToBePlayed() {
        int numberOfBorderVillagesInHand = owner.getCardsFromHand(DomCardName.BorderVillage).size();
