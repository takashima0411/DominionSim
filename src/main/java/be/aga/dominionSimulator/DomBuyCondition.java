    ...
    public boolean isTrue(DomPlayer owner) {
        switch (leftFunction) {
            ...
            case tokensOnDefiledShrine:
                leftValue = owner.getCurrentGame().getBoard().countVPon(DomCardName.DefiledShrine);
                break;
        ...
        switch (rightFunction) {
            ...
            case countGainedCards:
                ...
                break;
            case tokensOnDefiledShrine:
                rightValue = owner.getCurrentGame().getBoard().countVPon(DomCardName.DefiledShrine);
                break;
            case isTravellingFairActive:
