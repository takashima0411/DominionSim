...
public class DomBoard extends EnumMap<DomCardName, ArrayList<DomCard>> {
    ...
    public void resetCommon() {
        ...
        if (isLandmarkActive(DomCardName.DefiledShrine))
    ...
    public void initialize() {
        ...
        createPrizePile();
        if (get(DomCardName.BlackMarket) != null)
    ...
    private void createBlackMarketDeck() {
        ...
        for (DomCardName theCardName : DomCardName.values()) {
            if (get(theCardName) == null) {
                if (theCardName != DomCardName.TreasureMap
    ...
    private void addCustomKingdoms() {
        for (DomPlayer thePlayer : players) {
            for (DomCardName theCard : thePlayer.getCardsNeededInSupply()) {
                ...
                if (theCard == DomCardName.Marauder || theCard == DomCardName.BanditCamp || theCard == DomCardName.Pillage)
                ...
                if (theCard == DomCardName.Page) {
                    addSeparatePile(DomCardName.TreasureHunter, 5);
    ...
    private void addSettlersPile() {
        ...
        get(DomCardName.Settlers).add(DomCardName.Settlers.createNewCardInstance());
        get(DomCardName.Settlers).add(DomCardName.Settlers.createNewCardInstance());
        get(DomCardName.Settlers).add(DomCardName.BustlingVillage.createNewCardInstance());
        get(DomCardName.Settlers).add(DomCardName.BustlingVillage.createNewCardInstance());
        get(DomCardName.Settlers).add(DomCardName.BustlingVillage.createNewCardInstance());
        get(DomCardName.Settlers).add(DomCardName.BustlingVillage.createNewCardInstance());
        get(DomCardName.Settlers).add(DomCardName.BustlingVillage.createNewCardInstance());
    ...
    private void addCastlesPile(int playerCount) {
        ...
        get(DomCardName.Castles).add(DomCardName.HumbleCastle.createNewCardInstance());
        get(DomCardName.Castles).add(DomCardName.CrumblingCastle.createNewCardInstance());
        get(DomCardName.Castles).add(DomCardName.SmallCastle.createNewCardInstance());
        get(DomCardName.Castles).add(DomCardName.HauntedCastle.createNewCardInstance());
        get(DomCardName.Castles).add(DomCardName.OpulentCastle.createNewCardInstance());
        get(DomCardName.Castles).add(DomCardName.SprawlingCastle.createNewCardInstance());
        get(DomCardName.Castles).add(DomCardName.GrandCastle.createNewCardInstance());
        get(DomCardName.Castles).add(DomCardName.KingsCastle.createNewCardInstance());
    ...
    private void addKnightsPile() {
        ...
        get(DomCardName.Knights).add(DomCardName.DameJosephine.createNewCardInstance());
        get(DomCardName.Knights).add(DomCardName.DameAnna.createNewCardInstance());
        get(DomCardName.Knights).add(DomCardName.DameMolly.createNewCardInstance());
        get(DomCardName.Knights).add(DomCardName.DameSylvia.createNewCardInstance());
        get(DomCardName.Knights).add(DomCardName.DameNatalie.createNewCardInstance());
        get(DomCardName.Knights).add(DomCardName.SirVander.createNewCardInstance());
        get(DomCardName.Knights).add(DomCardName.SirMichael.createNewCardInstance());
        get(DomCardName.Knights).add(DomCardName.SirMartin.createNewCardInstance());
        get(DomCardName.Knights).add(DomCardName.SirDestry.createNewCardInstance());
        get(DomCardName.Knights).add(DomCardName.SirBailey.createNewCardInstance());
        Collections.shuffle(get(DomCardName.Knights));
    }
    ...
    private void addRuinsPile() {
        ...
        for (int i = 0; i < 2; i++) {
            get(DomCardName.Ruins).add(DomCardName.AbandonedMine.createNewCardInstance());
            get(DomCardName.Ruins).add(DomCardName.Survivors.createNewCardInstance());
            get(DomCardName.Ruins).add(DomCardName.RuinedMarket.createNewCardInstance());
            get(DomCardName.Ruins).add(DomCardName.RuinedVillage.createNewCardInstance());
            get(DomCardName.Ruins).add(DomCardName.RuinedLibrary.createNewCardInstance());
        }
        Collections.shuffle(get(DomCardName.Ruins));
    }
    ...
    public DomCard take(DomCardName aCardName) {
        ...
        if (aCardName == DomCardName.BustlingVillage)
        ...
        if (aCardName == DomCardName.Gladiator
                ...
                || aCardName == DomCardName.BustlingVillage
    ...
    public int count(DomCardName aCardName) {
        ...
        if (theList == null || theList.isEmpty())
            return 0;
        if (theList.get(0).getName() != theCardName && aCardName.hasCardType(DomCardType.SplitPile))
            return 0;
        return theList.size();
    }
    ...
    public void add(DomCard aCard) {
        ...
        if (aCard.getName() == DomCardName.BustlingVillage) {
